...
//   std::cout << " b_SF_Medium= " << b_SF_Medium << std::endl;
//   std::cout << " light_SF_Medium= " << light_SF_Medium << std::endl;
//   std::cout << " light_eff_Medium= " << light_eff_Medium << std::endl;

//   std::cout << " b_SF_Loose= " << b_SF_Loose << std::endl;
//   std::cout << " light_SF_Loose= " << light_SF_Loose << std::endl;
//   std::cout << " light_eff_Loose= " << light_eff_Loose << std::endl;
